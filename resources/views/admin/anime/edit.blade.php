                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.anime.update', $anime->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $anime->title }}" type="text" name="title" id="inputName" class="form-control">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="inputDescription" class="form-control" rows="4">{{ $anime->content }}</textarea>
                                @error('content')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input value="{{ $anime->preview_photo }}" name="preview_photo" accept="image/jpeg,image/png" type="file" class="custom-file-input" id="inputGroupFile01"
                            ...
                            <div class="form-group">
                                ...
                                <select name="voiceovers[]" multiple class="form-control" id="exampleFormControlSelect2">
                                    @foreach($voiceovers as $voiceover)
                                        <option
                                            @foreach($anime->voiceover as $animeVoiceover)
                                                {{ $voiceover->id == $animeVoiceover->id ? 'selected' : '' }}
                                            @endforeach
